...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(KayoMaliciousDetection.malicious,"Malicious Page Count","Malicious Page Count");
	localDefaultCategoryDataset.addValue(KayoMaliciousDetection.benign,"Benign Page Count","Benign Page Count");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Detection Type", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
